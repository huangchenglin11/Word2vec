...
print(f"\n模型在测试集上的损失值: {train_state['test_loss']:.4f}")
print(f"模型在测试集上的分类准确率: {train_state['test_acc']:.2f}%")
...
for surname in surnames:
    ...
    print(
        f"姓: {prediction['surname']}, 预测国籍: {prediction['nationality']}, 概率置信度: {prediction['probability']:.4f}")
